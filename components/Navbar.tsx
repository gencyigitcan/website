        ...
        <nav className="fixed top-0 w-full z-50 transition-all duration-300 nav-glass">
            <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
                <Link href="/" className="flex items-center gap-2 group">
                    <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#DFB574] to-[#C09453] flex items-center justify-center text-sm shadow-lg group-hover:scale-110 transition-transform text-white font-bold">
                        YG
                    </div>
                ...
                <div className="flex items-center gap-2 md:gap-4">
                    ...
                    <Link
                        href="/admin"
                        className="p-2 rounded-full hover:bg-black/5 dark:hover:bg-white/10 transition-all text-fg-muted hover:text-[#DFB574] dark:hover:text-[#DFB574] hover:scale-110 active:scale-95"
