        ...
        <aside className="w-64 border-r border-white/5 bg-black/5 backdrop-blur-xl flex flex-col fixed h-full z-10 hidden md:flex">
            <div className="p-6 border-b border-white/5">
                <Link href="/" className="flex items-center gap-2">
                    <div className="w-8 h-8 rounded-full bg-gradient-to-br from-blue-600 to-blue-900 flex items-center justify-center text-sm font-bold text-white shadow-lg">
                        YG
                    </div>
                    <span className="font-serif text-lg tracking-wide text-fg-primary">Admin<span className="text-blue-500">Panel</span></span>
                </Link>
            </div>
